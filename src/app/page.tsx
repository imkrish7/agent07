...
export default function Home() {
  return (
      <main className="min-h-screen bg-gradient-to-b from-white to-gray-50/50 flex items-center justify-center">
		<div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right, #e5e5e5_1px, transparent_1px), linear-gradient(
			to_bottom,#e5e5e5_1px, transparent_1px
		)] bg-[size:6rem_4rem]"></div>
		<section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-6 flex flex-col items-center space-y-10 text-center">
			<header className="space-y-6">
				...
				<p className="max-x-[600px] text-lg text-gray-600 md:text-xl/relaxed xl:text-2xl/relaxed">
					Meet your new AI chat compainion that goes beyond conversation - it can actually get things done!
					<br />
